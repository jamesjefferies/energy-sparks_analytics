...
class AlertElectricityBaseloadVersusBenchmarkNew < AlertAnalysisBase
  ...
  TEMPLATE_VARIABLES = {
    # units
    benchmark_per_pupil: { description: "This is the benchmark per pupil, measured in kW", example_data: { poor: '10.0', good: '20.0' }, units: "kW"},
    benchmark_per_floor_area: { description: "This is the benchmark per floor area, measured in kW", example_data: { poor: '10.0', good: '20.0' }, units: "kW"},
    baseload: { description: "This is the electricity baseload, measured in kW", example_data: { poor: '1000.0', good: '200.0' }, units: "kW"},
  }.freeze
  ...
  def analyse(asof_date)
    ...
    # For example
      ...
      report.status = :no_action_required
    else
      report.status = :good
    end
